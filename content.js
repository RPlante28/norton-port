...
" \\_____________/   SNAKE.BAS  (c) 1982",
    ...
    const root = { name:'C:\\ROHAN', path:'C:\\ROHAN', children:[
      ...
      { name:'AWARDS', kind:'dir', size:'\u25b6SUB-DIR\u25c4', date:'11.20.24', children:[
        ...
        { name:'CYBER .AWD', kind:'file', size:'1 536', date:'11.15.22', doc:D({ title:'Fall 2022 National Cyber League', meta:'DATE EARNED: FALL 2022', sub:'National collegiate cybersecurity competition (Cyber Skyline).', link:'https://nationalcyberleague.org', linkLabel:'SOURCE \u25b8', bullets:[
