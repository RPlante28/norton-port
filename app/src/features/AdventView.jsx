  ...
  return (
    <div className="p-[18px] text-center">
      ...
      <div className="text-[13.5px] leading-[1.6] max-w-[46ch] mx-auto mb-4">
        A text adventure inside this machine, loosely based on true events. Two acts: get the reseated machine to POST, then reconstruct a lost DISKREET passphrase and unseal the disk. Tap buttons or type. Progress is saved.
      </div>
